...
| [DiffusionPDE](https://github.com/jhhuangchloe/DiffusionPDE) | `1e2bc8b9e312f3a936630a30d2f49aedabf0cea7` | CC BY-NC-SA 4.0 | Conceptual partial-observation reference only. No source was copied; the selectable plain-CNN and conditional-U-Net denoisers are clean local implementations. |
...
| [PhyCoFlow topology development](https://github.com/jachen25/PhyCoFlow_dev/tree/main/src) | v1: `ab49ea37a`; v2: `0ae5ef73bf3d76c0d07f53695f35a525a51cdf31` plus the [audited working-tree hashes](topology_source_manifest.json) | Project-supervised contribution | V1 preserves historical straight-through Betti curves. V2 adapts N195/N197 selected-field spatial self, derived-anchor self, and generated-output mutual objectives, with exact H0/H1 evaluation. The common trainer, other coherence families and case physics remain separate. No sibling checkout is required at runtime. |
